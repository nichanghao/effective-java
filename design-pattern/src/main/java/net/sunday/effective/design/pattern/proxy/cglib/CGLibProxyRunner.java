package net.sunday.effective.design.pattern.proxy.cglib;

import net.sf.cglib.core.DebuggingClassWriter;
import net.sunday.effective.design.pattern.proxy.cglib.interceptor.UserServiceCGLibInterceptor;
...
public class CGLibProxyRunner {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty(DebuggingClassWriter.DEBUG_LOCATION_PROPERTY,
                System.getProperty("user.dir") + "/design-pattern/build/classes/cglib_proxy_class/");
