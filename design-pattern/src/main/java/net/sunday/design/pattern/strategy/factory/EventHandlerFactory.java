package net.sunday.design.pattern.strategy.factory;

import net.sunday.design.pattern.strategy.event.EventBaseHandler;
...
public class EventHandlerFactory implements InitializingBean, ApplicationContextAware {
    ...
    private List<EventBaseHandler> eventBaseHandlerList = new ArrayList<>();
