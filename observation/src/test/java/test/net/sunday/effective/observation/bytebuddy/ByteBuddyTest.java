package test.net.sunday.effective.observation.bytebuddy;
...
import net.sunday.effective.observation.agent.interceptor.InstMethodInterceptor;
import net.sunday.effective.observation.agent.util.AgentUtils;
...
public class ByteBuddyTest {
    ...
    void testAgentBuilder() {
        ...
        AgentUtils.newAgentBuilder()
                  .type(ElementMatchers.named("net.sunday.effective.observation.agent.entity.Person"))
    ...
    void testAgentBuilderWithBootstrap() {
        ...
        String templateClassName = "net.sunday.effective.observation.agent.interceptor.BootstrapInstMethodInterceptor";
