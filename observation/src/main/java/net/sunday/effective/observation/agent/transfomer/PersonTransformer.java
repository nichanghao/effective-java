package net.sunday.effective.observation.agent.transfomer;
...
public class PersonTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader,
        ...
        if (!(className.startsWith("net.sunday.effective.observation.agent.entity.Person")
                || className.startsWith("net/sunday/effective/observation/agent/entity/Person"))) {
